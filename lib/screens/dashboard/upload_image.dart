...
class _UploadImagePageState extends State<UploadImagePage>
  ...
  // Updated labels for pneumonia detection
  final List<String> _labels = ['pneumonia', 'normal', 'notpneumonia'];
  ...
  Future<void> loadModel() async {
    try {
      ...
      _interpreter = await Interpreter.fromAsset(
          'assets/newPneumoniaModel.tflite',
  ...
  Future<Map<String, dynamic>> runInference(File imageFile) async {
    try {
      ...
      // Check if the result is "notpneumonia"
      if (_labels[maxIndex] == 'notpneumonia') {
        return {
          'isChestXray': false,
          'rawOutput': result,
        };
      ...
      bool isPneumonia = _labels[maxIndex] == 'pneumonia';

      // Create probability map for pneumonia and normal
      ...
      return {
        'isChestXray': true,
        'isPneumonia': isPneumonia, // Explicitly added
          ...
          child: Container(
            ...
            child: Column(
              ...
              children: [
                ...
                const Text(
                  'Please select a chest X-ray image only',
                  style: TextStyle(
          ...
          child: Container(
            ...
            child: Column(
              ...
              children: [
                ...
                const SizedBox(height: 15),
                const Text(
                  'This does not appear to be a chest X-ray image.',
                  textAlign: TextAlign.center,
                  style: TextStyle(
                    fontSize: 16,
                ...
                const Text(
                  'Please upload a valid chest X-ray image for accurate diagnosis.',
                  textAlign: TextAlign.center,
                  style: TextStyle(
                    fontWeight: FontWeight.bold,
                    fontSize: 16,
  ...
  void _processImage() async {
    ...
    try {
      ...
      if (result.containsKey('isChestXray') && result['isChestXray'] == false) {
        if (mounted) {
          _showNonChestXrayWarning();
        }
        return;
      }

      if (mounted) {
        // Extract isPneumonia and confidence from result
        final bool isPneumonia = result['isPneumonia'] ?? false;
                                  ...
                                  Container(
                                    ...
                                    child: const Row(
                                      children: [
                                        ...
                                        Expanded(
                                          child: Text(
                                            'Please upload a clear chest X-ray image for accurate analysis',
                                            style: TextStyle(
                                              fontSize: 14,
                                              color: AppColors.primaryRed,
                                              fontWeight: FontWeight.w500,
...
// WavePainter and DashedBorder classes remain unchanged
